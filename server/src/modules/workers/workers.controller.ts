...
export async function upsertMyProfile(req: AuthedRequest, res: Response, next: NextFunction) {
  try {
...
export async function patchMyProfile(req: AuthedRequest, res: Response, next: NextFunction) {
  try {
...
// Skills
// =====================================================
export async function upsertMySkills(req: AuthedRequest, res: Response, next: NextFunction) {
  try {
...
// Portfolio
// =====================================================
export async function listMyPortfolio(req: AuthedRequest, res: Response, next: NextFunction) {
  try {
...
export async function addPortfolioItem(req: AuthedRequest, res: Response, next: NextFunction) {
  try {
...
export async function deletePortfolioItem(req: AuthedRequest, res: Response, next: NextFunction) {
  try {
...
// Admin
// =====================================================
export async function listPendingWorkers(_req: AuthedRequest, res: Response, next: NextFunction) {
  try {
...
export async function verifyWorker(req: AuthedRequest, res: Response, next: NextFunction) {
  try {
    const input = adminVerifyWorkerSchema.parse(req.body);
    const profile = await service.verifyWorker(userId(req), req.params.id, input);
